...
export default function SignUpNext() {
    ...
    const handleNext = async () => {
        try {
          ...
          await register(firstName, lastName, mobileNumber);
    
          // Registration successful, navigate to the 'PayMethod' screen
    ...
    return (
        <ImageBackground source={backgroundImage} style={styles.backgroundImage}>
            <View style={styles.container}>
                ...
                <Text style={styles.header}>Fill in your bio to get {"\n"} started</Text>
                <Text style={styles.subheader}>This data will be displayed in your account {"\n"}profile for security </Text>
